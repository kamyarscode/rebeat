...
function App() {
  ...
  return (
    <main className="flex flex-col gap-6 container mx-auto justify-center items-center h-full px-8 max-w-md">
      ...
      <div className="flex flex-col gap-3 w-full">
        ...
        {isAuthenticated && user && (
          <div className="animate-in fade-in slide-in-from-bottom-4 delay-700 fill-mode-backwards ease-out-quart duration-1000">
            <Button
              variant="link"
              className="w-fit hover:text-destructive focus-visible:text-destructive p-0"
              onClick={() => {
                logout();
              }}
            >
